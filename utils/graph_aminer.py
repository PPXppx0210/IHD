...
def get_shorten_cascades_nocontent(diffusion_nocontent, us):
    # diffusion_nocontent = load_pickle("/remote-home/share/dmb_nas/ppx/HeterGAT/Aminer-pre/diffusion_withoutcontent_newids.pkl")
    # us = load_pickle("/remote-home/share/dmb_nas/ppx/HeterGAT/Aminer-pre/user_ids.pkl")
...
def get_shorten_cascades_withcontent(diffusion_withcontent, us):
    # diffusion_withcontent = load_pickle("/remote-home/share/dmb_nas/ppx/HeterGAT/Aminer-pre/diffusion_withcontent_newids.pkl")
    # us = load_pickle("/remote-home/share/dmb_nas/ppx/HeterGAT/Aminer-pre/user_ids.pkl")
