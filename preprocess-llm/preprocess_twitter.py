...
def build_parser():
    ...
    parser = argparse.ArgumentParser(description="Build Twitter topic diffusion graphs from LLM topic assignments.")
    ...
    parser.add_argument("--result-file", type=str, default=os.path.join(PPX_SHARE_ROOT, "result_twitter.jsonl"))
    ...
    parser.add_argument("--map-users", action="store_true", help="Map result ids through u2idx before building edges.")
...
def main():
    ...
    u2idx = load_pickle(u2idx_file) if args.map_users else None
